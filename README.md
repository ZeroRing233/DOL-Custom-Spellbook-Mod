...
## 安装方式说明
本模组基于0.5.2.x/0.5.3.x版本进行自测，旧版本会存在不兼容的问题，请确保您手上的游戏是最新版本，然后下载release下[1.0.0-alpha](https://github.com/ZeroRing233/DOL-Custom-Spellbook-Mod/releases/tag/1.0.0-alpha)中的Custom-Spellbook-1.0.0.mod.zip（请不要下载source code），并使用平时游玩汉化版时使用的mod管理器加载完汉化模组后，再加载此模组。
...
- 百度贴吧：[自定义魔法书（言灵集）模组测试版](https://tieba.baidu.com/p/9428101193)
